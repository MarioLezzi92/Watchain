...
export default function WatchDetailsModal({ open, onClose, item, role, onList, onCancel, onBuy, onCertify, busy }) {
  ...
  // Se è listato, il "proprietario" per il frontend è il Seller
  ...
  // LOGICA CERTIFICAZIONE:
  // 1. Sono Reseller
  // 2. È mio (nel mio inventario)
  // 3. Non è certificato
  // 4. Non è in vendita (devo averlo nel vault)
          ...
          <div className="mt-8 pt-6 border-t border-white/10 space-y-4">
            ...
            {canManage && (
              <div className="space-y-4">
                ...
                {/* --- PULSANTE CERTIFICA (SOLO RESELLER) --- */}
                {canCertify && (
                   <button
                ...
                {/* --- LISTING --- */}
                {/* Se Reseller: può listare SOLO se certificato */}
                ...
                {/* Messaggio di avviso per Reseller */}
            ...
            {/* ACQUISTO (Se non sono io il proprietario) */}
            {!canManage && isListed && (
              <button
